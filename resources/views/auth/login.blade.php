  ...
  <div class="sv-login-brand">
    ...
    <div class="sv-login-brand__content">
      <img src="{{ asset('images/seguros-vega-logo-dark.png') }}"
           alt="Seguros Vega" class="sv-login-brand__logo">
  ...
  <div class="sv-login-form-panel">
    ...
    <div class="sv-login-form-container">
      ...
      <div class="sv-login-logo-mobile">
        <img src="{{ asset('images/seguros-vega-logo-light.png') }}" alt="Seguros Vega" style="max-width:160px">
      </div>
      ...
      <form action="{{ route('login.post') ?? '#' }}" method="POST" class="sv-login-form">
        @csrf
        ...
        <div class="sv-field" x-data="{ showPass: false }">
          ...
          <div class="sv-field__input-wrapper">
            ...
            <input
              ...
              id="password"
              name="password"
              class="sv-input sv-input--with-toggle"
